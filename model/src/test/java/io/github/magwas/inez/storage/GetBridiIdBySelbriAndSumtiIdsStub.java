...
public class GetBridiIdBySelbriAndSumtiIdsStub implements BridiFieldTestData {
	public static GetBridiIdBySelbriAndSumtiIds stub() {
		GetBridiIdBySelbriAndSumtiIds mock = mock(
				GetBridiIdBySelbriAndSumtiIds.class);
