...
public class FindAllByRepresentationStub implements BridiTestData {
	public static FindAllByRepresentation stub() {
		FindAllByRepresentation mock = mock(FindAllByRepresentation.class);
		...
		when(mock.apply(Inez.QUERY_BRIDI_ID)).thenAnswer((args) -> Stream.of(ANY));
		return mock;
	}
}
