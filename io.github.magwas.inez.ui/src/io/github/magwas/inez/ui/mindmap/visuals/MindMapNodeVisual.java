...
public class MindMapNodeVisual extends Region {
	...
	public MindMapNodeVisual() {
		...
		labelVBox.setPadding(new Insets(VERTICAL_PADDING, HORIZONTAL_PADDING,
		...
		descriptionFlow.maxWidthProperty()
				.bind(shape.widthProperty().subtract(HORIZONTAL_PADDING * 2));
