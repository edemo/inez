...
public interface ParserOutputTestData extends BridiFieldTestData {
	...
	ParserOutput OUTPOUT_WITH_LITERAL = new ParserOutput(INPUT_WITH_LITERAL,
			Map.of(INPUT_WITH_LITERAL, INPUT_WITH_LITERAL_REFS));
	...
	ParserOutput OUTPUT_ANY = new ParserOutput(ParserConstants.QUERY_BRIDI_ID,
			Map.of());
	...
	ParserOutput OUTPUT_ALL_ANY = new ParserOutput(QUERY_STRING_ALL_ANY,
			Map.of(QUERY_STRING_ALL_ANY, List.of(IS_A_REPR,
					ParserConstants.QUERY_BRIDI_ID, ParserConstants.QUERY_BRIDI_ID)));
